# Generated by Django 5.0.3 on 2024-04-28 13:23
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('main', '0003_productdescription_alter_formdata_email_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Звичайний користувач'), ('manager', 'Менеджер'), ('admin', 'Адміністратор')], default='user', max_length=10)),
